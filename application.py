...
db_config = {
    'host': 'brianketaren.mysql.pythonanywhere-services.com',
    'user': 'brianketaren',
    'password': 'diapredict140802!',
    'database': 'brianketaren$DiaPredict'
}
...
@application.route('/update_account', methods=['POST'])
def update_account():
    if 'user_id' not in session:
        return redirect('/login')
    else:
...
@application.route('/edit_username', methods = ['GET', 'POST'])
def edit_username():
    if 'user_id' not in session:
        return redirect('/login')
    else:
...
@application.route('/perkembangan')
def perkembangan():
    if 'user_id' not in session:
        return redirect('/login')
    else:
...
@application.route('/delete_perkembangan/<int:predict_id>', methods=['GET', 'POST'])
...
@application.route('/edit_perkembangan/<int:predict_id>', methods=['GET', 'POST'])
...
@application.route('/get_pregnancies_data')
...
@application.route('/get_glucose_data')
...
@application.route('/get_BloodPressure_data')
...
@application.route('/get_SkinThickness_data')
...
@application.route('/get_Insulin_data')
...
@application.route('/get_BMI_data')
def get_BMI_data():
    if 'user_id' not in session:
        return redirect('/login')
    else:
...
@application.route('/get_DPF_data')
def get_DPF_data():
    if 'user_id' not in session:
        return redirect('/login')
    else:
...
@application.route('/get_prediksi_data')
...
@application.route('/delete_predict/<int:predict_id>', methods=['GET', 'POST'])
...
@application.route('/edit_predict/<int:predict_id>', methods=['GET', 'POST'])
...
@application.route('/delete_user/<int:user_id>', methods=['GET', 'POST'])
